<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        // Cập nhật thông tin lớp học trong cơ sở dữ liệu, không cho phép sửa mã lớp
        $sql = "UPDATE lophoc SET tenLop='$tenLopMoi' WHERE maLop='$maLop'";
...
<body>
    <div class="container" style="max-width: 500px; margin: 0 auto; text-align: center;">
        <h2 align="center">Sửa Thông Tin Lớp Học</h2>
        <form method="post" action="">
            <div class="form-group">
                <label for="maLop">Mã Lớp:</label>
                <!-- Trường nhập cho mã lớp, thêm thuộc tính readonly để không cho phép sửa -->
