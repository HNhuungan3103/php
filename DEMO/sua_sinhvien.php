...
<body>
    ...
    <div class="container">
        <h2 align="center">SỬA THÔNG TIN SINH VIÊN</h2>
        ...
        <form method="post" action="">
            ...
            <div class="form-group">
                ...
                <select class="form-control" id="gioiTinh" name="gioiTinh" required>
                    ...
                    if ($row['gioiTinh'] == 'Nam') echo 'selected'; 
                    ?>>Nam</option>

                    <option value="Nữ" <?php 
                    if ($row['gioiTinh'] == 'Nữ') echo 'selected'; 
                    ?>>Nữ</option>
                </select>
            </div>
            <div class="form-group">
                ...
                <select class="form-control" id="malop" name="maLop" required>
                    <option value=""><?php echo htmlspecialchars($row['maLop']); ?></option>
                    <?php 
                    include_once("connect.php");
            ...
            <a href="sinhvien.php" class="btn btn-secondary">Hủy</a> <!-- Nút hủy quay lại trang sinh viên -->
        </form>
